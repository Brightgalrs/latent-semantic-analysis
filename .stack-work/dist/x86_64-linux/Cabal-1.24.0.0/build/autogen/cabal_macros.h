...
/* package lsa-0.1.0.0 */
#define VERSION_lsa "0.1.0.0"
#define MIN_VERSION_lsa(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "lsa-0.1.0.0-CC3xkMaiX1fG0UlayJzoZH"

#define CURRENT_PACKAGE_KEY "lsa-0.1.0.0-CC3xkMaiX1fG0UlayJzoZH"
